...
CONTEXTFORGE_ENABLE_RUST_MCP_TELEMETRY_BUILD="${CONTEXTFORGE_ENABLE_RUST_MCP_TELEMETRY_BUILD:-false}"
...
EXPERIMENTAL_RUST_MCP_TELEMETRY_ENABLED="${EXPERIMENTAL_RUST_MCP_TELEMETRY_ENABLED:-}"
EXPERIMENTAL_RUST_MCP_TELEMETRY_PATH="${EXPERIMENTAL_RUST_MCP_TELEMETRY_PATH:-}"
EXPERIMENTAL_RUST_MCP_TELEMETRY_ROTATE_BYTES="${EXPERIMENTAL_RUST_MCP_TELEMETRY_ROTATE_BYTES:-}"
EXPERIMENTAL_RUST_MCP_TELEMETRY_MAX_BYTES="${EXPERIMENTAL_RUST_MCP_TELEMETRY_MAX_BYTES:-}"
EXPERIMENTAL_RUST_MCP_TOKIO_CONSOLE_ENABLED="${EXPERIMENTAL_RUST_MCP_TOKIO_CONSOLE_ENABLED:-}"
EXPERIMENTAL_RUST_MCP_TOKIO_CONSOLE_BIND="${EXPERIMENTAL_RUST_MCP_TOKIO_CONSOLE_BIND:-}"
MCP_RUST_TELEMETRY_ENABLED="${MCP_RUST_TELEMETRY_ENABLED:-}"
MCP_RUST_TELEMETRY_PATH="${MCP_RUST_TELEMETRY_PATH:-}"
MCP_RUST_TELEMETRY_ROTATE_BYTES="${MCP_RUST_TELEMETRY_ROTATE_BYTES:-}"
MCP_RUST_TELEMETRY_MAX_BYTES="${MCP_RUST_TELEMETRY_MAX_BYTES:-}"
MCP_RUST_TOKIO_CONSOLE_ENABLED="${MCP_RUST_TOKIO_CONSOLE_ENABLED:-}"
MCP_RUST_TOKIO_CONSOLE_BIND="${MCP_RUST_TOKIO_CONSOLE_BIND:-}"
...
apply_rust_mcp_mode_defaults() {
    ...
    if [[ -z "${MCP_RUST_TELEMETRY_ENABLED}" ]]; then
        MCP_RUST_TELEMETRY_ENABLED="${EXPERIMENTAL_RUST_MCP_TELEMETRY_ENABLED}"
    fi
    if [[ -z "${MCP_RUST_TELEMETRY_PATH}" ]]; then
        MCP_RUST_TELEMETRY_PATH="${EXPERIMENTAL_RUST_MCP_TELEMETRY_PATH}"
    fi
    if [[ -z "${MCP_RUST_TELEMETRY_ROTATE_BYTES}" ]]; then
        MCP_RUST_TELEMETRY_ROTATE_BYTES="${EXPERIMENTAL_RUST_MCP_TELEMETRY_ROTATE_BYTES}"
    fi
    if [[ -z "${MCP_RUST_TELEMETRY_MAX_BYTES}" ]]; then
        MCP_RUST_TELEMETRY_MAX_BYTES="${EXPERIMENTAL_RUST_MCP_TELEMETRY_MAX_BYTES}"
    fi
    if [[ -z "${MCP_RUST_TOKIO_CONSOLE_ENABLED}" ]]; then
        MCP_RUST_TOKIO_CONSOLE_ENABLED="${EXPERIMENTAL_RUST_MCP_TOKIO_CONSOLE_ENABLED}"
    fi
    if [[ -z "${MCP_RUST_TOKIO_CONSOLE_BIND}" ]]; then
        MCP_RUST_TOKIO_CONSOLE_BIND="${EXPERIMENTAL_RUST_MCP_TOKIO_CONSOLE_BIND}"
    fi
    ...
    export EXPERIMENTAL_RUST_MCP_TELEMETRY_ENABLED
    export EXPERIMENTAL_RUST_MCP_TELEMETRY_PATH
    export EXPERIMENTAL_RUST_MCP_TELEMETRY_ROTATE_BYTES
    export EXPERIMENTAL_RUST_MCP_TELEMETRY_MAX_BYTES
    export EXPERIMENTAL_RUST_MCP_TOKIO_CONSOLE_ENABLED
    export EXPERIMENTAL_RUST_MCP_TOKIO_CONSOLE_BIND
    ...
    export MCP_RUST_TELEMETRY_ENABLED
    if [[ -n "${MCP_RUST_TELEMETRY_PATH}" ]]; then
        export MCP_RUST_TELEMETRY_PATH
    else
        unset MCP_RUST_TELEMETRY_PATH || true
    fi
    if [[ -n "${MCP_RUST_TELEMETRY_ROTATE_BYTES}" ]]; then
        export MCP_RUST_TELEMETRY_ROTATE_BYTES
    else
        unset MCP_RUST_TELEMETRY_ROTATE_BYTES || true
    fi
    if [[ -n "${MCP_RUST_TELEMETRY_MAX_BYTES}" ]]; then
        export MCP_RUST_TELEMETRY_MAX_BYTES
    else
        unset MCP_RUST_TELEMETRY_MAX_BYTES || true
    fi
    export MCP_RUST_TOKIO_CONSOLE_ENABLED
    if [[ -n "${MCP_RUST_TOKIO_CONSOLE_BIND}" ]]; then
        export MCP_RUST_TOKIO_CONSOLE_BIND
    else
        unset MCP_RUST_TOKIO_CONSOLE_BIND || true
    fi
}
