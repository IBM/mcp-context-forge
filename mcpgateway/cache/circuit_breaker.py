...
class CircuitBreaker:
    ...
    def __init__(self, failure_threshold: int = 5, timeout: int = 60, half_open_max_calls: int = 3, name: str = "circuit_breaker"):
        ...
        logger.info(f"Initialized circuit breaker '{name}' " f"(threshold={failure_threshold}, timeout={timeout}s)")
    ...
    def is_closed(self) -> bool:
        ...
        Returns:
            bool: True if circuit is in closed state, False otherwise.
        """
    ...
    def is_open(self) -> bool:
        ...
        Returns:
            bool: True if circuit is in open state, False otherwise.
        """
    ...
    def is_half_open(self) -> bool:
        ...
        Returns:
            bool: True if circuit is in half-open state, False otherwise.
        """
