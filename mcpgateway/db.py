...
class SSOProvider(Base):
    ...
    like GitHub, Google, IBM Security Verify, Okta, and Microsoft Entra ID.
    ...
    id: Mapped[str] = mapped_column(String(50), primary_key=True)  # github, google, ibm_verify, okta, entra
