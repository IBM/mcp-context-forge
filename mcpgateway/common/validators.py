...
class SecurityValidator:
    ...
    TOOL_NAME_PATTERN = settings.validation_tool_name_pattern  # Default: ^[a-zA-Z0-9_.-]+$ (MCP 2025-11-25)
    ...
    def validate_tool_name(cls, value: str) -> str:
        ...
        if not re.fullmatch(cls.TOOL_NAME_PATTERN, value):
