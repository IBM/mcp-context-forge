...
class TaskStatusUpdateEvent(_message.Message):
    ...
    metadata: _struct_pb2.Struct
    def __init__(
        self, task_id: _Optional[str] = ..., context_id: _Optional[str] = ..., status: _Optional[_Union[TaskStatus, _Mapping]] = ..., metadata: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ...
    ) -> None: ...
...
class AgentCard(_message.Message):
    ...
    def __init__(
        ...
        security_requirements: _Optional[_Iterable[_Union[SecurityRequirement, _Mapping]]] = ...,
        ...
        supported_interfaces: _Optional[_Iterable[_Union[AgentInterface, _Mapping]]] = ...,
...
class SecurityScheme(_message.Message):
    ...
    def __init__(
        self,
        api_key_security_scheme: _Optional[_Union[APIKeySecurityScheme, _Mapping]] = ...,
        http_auth_security_scheme: _Optional[_Union[HTTPAuthSecurityScheme, _Mapping]] = ...,
        oauth2_security_scheme: _Optional[_Union[OAuth2SecurityScheme, _Mapping]] = ...,
        open_id_connect_security_scheme: _Optional[_Union[OpenIdConnectSecurityScheme, _Mapping]] = ...,
        mtls_security_scheme: _Optional[_Union[MutualTlsSecurityScheme, _Mapping]] = ...,
    ) -> None: ...
...
class OAuthFlows(_message.Message):
    ...
    def __init__(
        self,
        authorization_code: _Optional[_Union[AuthorizationCodeOAuthFlow, _Mapping]] = ...,
        client_credentials: _Optional[_Union[ClientCredentialsOAuthFlow, _Mapping]] = ...,
        implicit: _Optional[_Union[ImplicitOAuthFlow, _Mapping]] = ...,
        password: _Optional[_Union[PasswordOAuthFlow, _Mapping]] = ...,
        device_code: _Optional[_Union[DeviceCodeOAuthFlow, _Mapping]] = ...,
    ) -> None: ...
...
class AuthorizationCodeOAuthFlow(_message.Message):
    ...
    pkce_required: bool
    def __init__(
        self, authorization_url: _Optional[str] = ..., token_url: _Optional[str] = ..., refresh_url: _Optional[str] = ..., scopes: _Optional[_Mapping[str, str]] = ..., pkce_required: bool = ...
    ) -> None: ...
...
class ListTasksRequest(_message.Message):
    ...
    def __init__(
        self,
        context_id: _Optional[str] = ...,
        status: _Optional[_Iterable[_Union[TaskState, str]]] = ...,
        page_size: _Optional[int] = ...,
        page_token: _Optional[str] = ...,
        status_timestamp_after: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ...,
        include_artifacts: bool = ...,
        tenant: _Optional[str] = ...,
    ) -> None: ...
