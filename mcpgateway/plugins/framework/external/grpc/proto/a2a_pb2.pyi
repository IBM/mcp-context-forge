...
class AgentInterface(_message.Message):
    __slots__ = ("url", "protocol_binding", "protocol_version", "tenant")
    URL_FIELD_NUMBER: _ClassVar[int]
    ...
    tenant: str
    def __init__(self, url: _Optional[str] = ..., protocol_binding: _Optional[str] = ..., protocol_version: _Optional[str] = ..., tenant: _Optional[str] = ...) -> None: ...

class AgentCard(_message.Message):
    __slots__ = ("name", "description", "icon_url", "provider", "version", "documentation_url", "capabilities", "security_schemes", "security_requirements", "default_input_modes", "default_output_modes", "skills", "supported_interfaces", "signatures")
    ...
    def __init__(self, name: _Optional[str] = ..., description: _Optional[str] = ..., icon_url: _Optional[str] = ..., provider: _Optional[_Union[AgentProvider, _Mapping]] = ..., version: _Optional[str] = ..., documentation_url: _Optional[str] = ..., capabilities: _Optional[_Union[AgentCapabilities, _Mapping]] = ..., security_schemes: _Optional[_Mapping[str, SecurityScheme]] = ..., security_requirements: _Optional[_Iterable[_Union[SecurityRequirement, _Mapping]]] = ..., default_input_modes: _Optional[_Iterable[str]] = ..., default_output_modes: _Optional[_Iterable[str]] = ..., skills: _Optional[_Iterable[_Union[AgentSkill, _Mapping]]] = ..., supported_interfaces: _Optional[_Iterable[_Union[AgentInterface, _Mapping]]] = ..., signatures: _Optional[_Iterable[_Union[AgentCardSignature, _Mapping]]] = ...) -> None: ...
...
class AgentCapabilities(_message.Message):
    ...
    def __init__(self, streaming: bool = ..., push_notifications: bool = ..., extensions: _Optional[_Iterable[_Union[AgentExtension, _Mapping]]] = ..., extended_agent_card: bool = ...) -> None: ...
...
class AuthorizationCodeOAuthFlow(_message.Message):
    ...
    pkce_required: bool
    def __init__(self, authorization_url: _Optional[str] = ..., token_url: _Optional[str] = ..., refresh_url: _Optional[str] = ..., scopes: _Optional[_Mapping[str, str]] = ..., pkce_required: bool = ...) -> None: ...
...
class SendMessageRequest(_message.Message):
    __slots__ = ("request", "configuration", "metadata", "tenant")
    ...
    metadata: _struct_pb2.Struct
    tenant: str
    def __init__(self, request: _Optional[_Union[Message, _Mapping]] = ..., configuration: _Optional[_Union[SendMessageConfiguration, _Mapping]] = ..., metadata: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ..., tenant: _Optional[str] = ...) -> None: ...

class GetTaskRequest(_message.Message):
    __slots__ = ("name", "history_length", "tenant")
    NAME_FIELD_NUMBER: _ClassVar[int]
    HISTORY_LENGTH_FIELD_NUMBER: _ClassVar[int]
    TENANT_FIELD_NUMBER: _ClassVar[int]
    name: str
    history_length: int
    tenant: str
    def __init__(self, name: _Optional[str] = ..., history_length: _Optional[int] = ..., tenant: _Optional[str] = ...) -> None: ...

class ListTasksRequest(_message.Message):
    __slots__ = ("context_id", "status", "page_size", "page_token", "status_timestamp_after", "include_artifacts", "tenant")
    CONTEXT_ID_FIELD_NUMBER: _ClassVar[int]
    STATUS_FIELD_NUMBER: _ClassVar[int]
    ...
    TENANT_FIELD_NUMBER: _ClassVar[int]
    context_id: str
    status: _containers.RepeatedScalarFieldContainer[TaskState]
    page_size: int
    page_token: str
    status_timestamp_after: _timestamp_pb2.Timestamp
    include_artifacts: bool
    tenant: str
    def __init__(self, context_id: _Optional[str] = ..., status: _Optional[_Iterable[_Union[TaskState, str]]] = ..., page_size: _Optional[int] = ..., page_token: _Optional[str] = ..., status_timestamp_after: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., include_artifacts: bool = ..., tenant: _Optional[str] = ...) -> None: ...
