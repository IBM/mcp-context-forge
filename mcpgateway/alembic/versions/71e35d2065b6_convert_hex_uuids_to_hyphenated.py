...
def upgrade() -> None:
    ...
    tables_to_convert = ["gateways", "servers", "tools", "resources", "prompts", "rate_limits", "api_keys", "audit_logs", "plugin_executions", "plugin_violations", "oauth_tokens", "oauth_clients"]
