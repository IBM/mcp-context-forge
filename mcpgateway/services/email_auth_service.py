...
class EmailAuthService:
    ...
    def _build_forgot_password_url() -> str:
        ...
        return f"{app_domain}{root_path}{settings.mcpgateway_ui_base_path}/forgot-password"
    ...
    def _build_reset_password_url(token: str) -> str:
        ...
        app_domain = str(getattr(settings, "app_domain", "http://localhost:4444")).rstrip("/")
        root_path = str(getattr(settings, "app_root_path", "")).rstrip("/")
        return f"{app_domain}{root_path}{settings.mcpgateway_ui_base_path}/reset-password/{safe_token}"
        ...
        try:
            ...
            if page is not None:
                pag_result = await unified_paginate(
                    ...
                    cursor=None,
                    limit=None,
                    base_url=f"{settings.app_root_path}{settings.mcpgateway_ui_base_path}/users",
                    query_params={},
                )
            ...
            if page is not None:
                ...
                return UsersListResult(
                    ...
                    links=PaginationLinks(  # pylint: disable=kwarg-superseded-by-positional-arg
                        self=f"{settings.app_root_path}{settings.mcpgateway_ui_base_path}/users?page=1&per_page={fallback_per_page}",
                        first=f"{settings.app_root_path}{settings.mcpgateway_ui_base_path}/users?page=1&per_page={fallback_per_page}",
                        last=f"{settings.app_root_path}{settings.mcpgateway_ui_base_path}/users?page=1&per_page={fallback_per_page}",
                    ),
                )
        ...
        try:
            ...
            if page is not None:
                ...
                pag_result = await unified_paginate(
                    ...
                    cursor=None,
                    limit=None,
                    base_url=f"{settings.app_root_path}{settings.mcpgateway_ui_base_path}/teams/{team_id}/non-members",
                    query_params={},
                )
                return UsersListResult(data=pag_result["data"], pagination=pag_result["pagination"], links=pag_result["links"])
            ...
            if page is not None:
                return UsersListResult(
                    ...
                    links=PaginationLinks(  # pylint: disable=kwarg-superseded-by-positional-arg
                        self=f"{settings.app_root_path}{settings.mcpgateway_ui_base_path}/teams/{team_id}/non-members?page=1&per_page={per_page or 30}",
                        first=f"{settings.app_root_path}{settings.mcpgateway_ui_base_path}/teams/{team_id}/non-members?page=1&per_page={per_page or 30}",
                        last=f"{settings.app_root_path}{settings.mcpgateway_ui_base_path}/teams/{team_id}/non-members?page=1&per_page={per_page or 30}",
                    ),
                )
