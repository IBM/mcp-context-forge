...
class PerformanceTracker:
    ...
    def track_operation(
        ...
        try:
            ...
            if log_slow and threshold_exceeded:
                ...
                logger.warning(
                    f"Slow operation detected: {operation_name} took {duration*1000:.2f}ms "
    ...
    def record_timing(
        ...
        if duration > threshold:
            ...
            logger.warning(
                f"Slow operation: {operation_name} took {duration*1000:.2f}ms",
                extra=context
            )
    ...
    def get_performance_summary(
        ...
        operations = (
            {operation_name: self.operation_timings[operation_name]}
            if operation_name and operation_name in self.operation_timings
            else self.operation_timings
        )
