...
class OpenAIEmbeddingProvider:
    ...
    Examples:
        >>> config = OpenAIEmbeddingConfig(  # doctest: +SKIP
        ...     api_key="sk-...",
        ...     model="text-embedding-3-small"
        ... )
        >>> provider = OpenAIEmbeddingProvider(config)  # doctest: +SKIP
        >>> provider.get_model_name()  # doctest: +SKIP
        'text-embedding-3-small'
...
class OllamaEmbeddingProvider:
    ...
    Examples:
        >>> config = OllamaEmbeddingConfig(model="nomic-embed-text")  # doctest: +SKIP
        >>> provider = OllamaEmbeddingProvider(config)  # doctest: +SKIP
        >>> provider.get_model_name()  # doctest: +SKIP
        'nomic-embed-text'
    """
...
class LiteLLMEmbeddingProvider:
    ...
    Examples:
        >>> config = LiteLLMEmbeddingConfig(  # doctest: +SKIP
        ...     base_url="http://localhost:4000",
        ...     model="text-embedding-3-small"
        ... )
        >>> provider = LiteLLMEmbeddingProvider(config)  # doctest: +SKIP
        >>> provider.get_model_name()  # doctest: +SKIP
        'text-embedding-3-small'
    """
...
class EmbeddingProviderFactory:
    ...
    Examples:
        >>> config = EmbeddingConfig(  # doctest: +SKIP
        ...     provider="openai",
        ...     config=OpenAIEmbeddingConfig(
        ...         api_key="sk-...",
        ...         model="text-embedding-3-small"
        ...     )
        ... )
        >>> provider = EmbeddingProviderFactory.create(config)  # doctest: +SKIP
        >>> provider.get_model_name()  # doctest: +SKIP
        'text-embedding-3-small'
    ...
    def create(embedding_config: EmbeddingConfig) -> Any:
        ...
        Examples:
            ...
            ... )
            >>> provider = EmbeddingProviderFactory.create(config)  # doctest: +SKIP
            >>> isinstance(provider, OpenAIEmbeddingProvider)  # doctest: +SKIP
            True
            ...
            ... )
            >>> provider = EmbeddingProviderFactory.create(config)  # doctest: +SKIP
            >>> isinstance(provider, OllamaEmbeddingProvider)  # doctest: +SKIP
            True
        """
