...
def get_trace(trace_id: str, db=Depends(_db_dependency)):
...
def get_query_performance(hours: int = Query(24, ge=1, le=168, description="Time window in hours"), db=Depends(_db_dependency)):
