...
async def get_oauth_status(gateway_id: str) -> dict:
...
async def fetch_tools_after_oauth(gateway_id: str, current_user: EmailUserResponse = Depends(get_current_user_with_permissions)) -> Dict[str, Any]:
...
async def list_registered_oauth_clients(current_user: EmailUserResponse = Depends(get_current_user_with_permissions)) -> Dict[str, Any]:  # noqa: ARG001
...
async def get_registered_client_for_gateway(
    gateway_id: str,
    current_user: EmailUserResponse = Depends(get_current_user_with_permissions),  # noqa: ARG001
) -> Dict[str, Any]:
...
async def delete_registered_client(client_id: str, current_user: EmailUserResponse = Depends(get_current_user_with_permissions)) -> Dict[str, Any]:  # noqa: ARG001
