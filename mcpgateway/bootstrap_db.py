        ...
        with Session(bind=conn) as db:
            ...
            default_roles = [
                {"name": "platform_admin", "description": "Platform administrator with all permissions", "scope": "global", "permissions": ["*"], "is_system_role": True},  # All permissions
                {
                    ...
                    "scope": "team",
                    "permissions": ["admin.dashboard",  "gateways.read", "servers.read","teams.read", "teams.update", "teams.join", "teams.manage_members", "tools.read", "tools.execute", "resources.read", "prompts.read"],
                    "is_system_role": True,
                },
                {
                    "name": "developer",
                    ...
                    "scope": "team",
                    "permissions": ["admin.dashboard",  "gateways.read", "servers.read","teams.join", "tools.read", "tools.execute", "resources.read", "prompts.read"],
                    "is_system_role": True,
                },
                {
                    "name": "viewer",
