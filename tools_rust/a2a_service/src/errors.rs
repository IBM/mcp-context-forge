...
mod tests {
    ...
    #[test]
    fn test_is_success_http_status() {
        assert!(is_success_http_status(200));
        assert!(is_success_http_status(201));
        assert!(is_success_http_status(299));
        assert!(!is_success_http_status(199));
        assert!(!is_success_http_status(300));
        assert!(!is_success_http_status(404));
        assert!(!is_success_http_status(500));
    }
}
