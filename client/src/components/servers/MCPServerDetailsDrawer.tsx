...
// Extended MCPServer type with optional fields that may be present
...
export function MCPServerDetailsDrawer({
  ...
  // Fetch components data - only when drawer is open and server exists
        ...
        {server && (
          <>
            <SheetHeader className="sr-only">
              <SheetTitle>MCP Server Details: {server.name}</SheetTitle>
              <SheetDescription>
                View details and configuration for this MCP server
              </SheetDescription>
            </SheetHeader>
