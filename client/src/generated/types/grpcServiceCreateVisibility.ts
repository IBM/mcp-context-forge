 ...
 */
export type GrpcServiceCreateVisibility =
  (typeof GrpcServiceCreateVisibility)[keyof typeof GrpcServiceCreateVisibility];

export const GrpcServiceCreateVisibility = {
  private: "private",
  team: "team",
  public: "public",
} as const;
