 ...
 */
export type TeamUpdateRequestVisibility =
  (typeof TeamUpdateRequestVisibility)[keyof typeof TeamUpdateRequestVisibility] | null;

export const TeamUpdateRequestVisibility = {
  private: "private",
  public: "public",
} as const;
