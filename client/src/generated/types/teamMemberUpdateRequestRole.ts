 ...
 */
export type TeamMemberUpdateRequestRole =
  (typeof TeamMemberUpdateRequestRole)[keyof typeof TeamMemberUpdateRequestRole];

export const TeamMemberUpdateRequestRole = {
  owner: "owner",
  member: "member",
} as const;
