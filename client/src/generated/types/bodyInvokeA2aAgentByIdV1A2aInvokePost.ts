 ...
 */
import type { BodyInvokeA2aAgentByIdV1A2aInvokePostParameters } from "./bodyInvokeA2aAgentByIdV1A2aInvokePostParameters";

export type BodyInvokeA2aAgentByIdV1A2aInvokePost = {
  /** Agent UUID or UAID */
  agent_id: string;
  parameters?: BodyInvokeA2aAgentByIdV1A2aInvokePostParameters;
