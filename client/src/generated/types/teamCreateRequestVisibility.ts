 ...
 */
export type TeamCreateRequestVisibility =
  (typeof TeamCreateRequestVisibility)[keyof typeof TeamCreateRequestVisibility];

export const TeamCreateRequestVisibility = {
  private: "private",
  public: "public",
} as const;
