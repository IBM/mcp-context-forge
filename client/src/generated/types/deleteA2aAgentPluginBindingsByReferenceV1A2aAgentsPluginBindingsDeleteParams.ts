...
export type DeleteA2aAgentPluginBindingsByReferenceV1A2aAgentsPluginBindingsDeleteParams = {
  /**
   * External reference ID whose bindings to delete
   * @minLength 1
   */
  binding_reference_id: string;
};
