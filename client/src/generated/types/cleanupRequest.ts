...
export type CleanupRequest = {
  /** Override retention period in days (0 = delete all) */
  retention_days?: number | null;
  /** Also clean up old rollup data */
  include_rollup?: boolean;
  /** Clean specific table: tool, resource, prompt, server, a2a_agent */
