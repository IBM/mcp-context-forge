...
class AgentTools:
    ...
    async def _evaluate_parameters(self, tool_calls: List[Dict[str, Any]], judge_model: str) -> float:
    ...
    async def _detect_hallucinations(self, reasoning_trace: List[Dict[str, Any]], context: Dict[str, Any], judge_model: str) -> Dict[str, Any]:
    ...
    async def _run_benchmark_task(self, task: Dict[str, Any], agent_config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def _analyze_task_failures(self, failed_criteria: List[Dict[str, Any]], agent_trace: Dict[str, Any]) -> Dict[str, Any]:
