...
class DocumentOperation:
    ...
    @staticmethod
    def create_document(file_path: str, title: Optional[str] = None, author: Optional[str] = None) -> Dict[str, Any]:
    ...
    @staticmethod
    def add_text(file_path: str, text: str, paragraph_index: Optional[int] = None, style: Optional[str] = None) -> Dict[str, Any]:
    ...
    @staticmethod
    def format_text(file_path: str, paragraph_index: int, run_index: Optional[int] = None,
                   bold: Optional[bool] = None, italic: Optional[bool] = None, underline: Optional[bool] = None,
                   font_size: Optional[int] = None, font_name: Optional[str] = None) -> Dict[str, Any]:
    ...
    @staticmethod
    def add_table(file_path: str, rows: int, cols: int, data: Optional[List[List[str]]] = None,
...
async def add_text(
    ...
    paragraph_index: Optional[int] = Field(None, description="Paragraph index to insert at (None for end)"),
    style: Optional[str] = Field(None, description="Style to apply"),
) -> Dict[str, Any]:
...
async def format_text(
    ...
    run_index: Optional[int] = Field(None, description="Run index within paragraph (None for entire paragraph)"),
    ...
    return doc_ops.format_text(file_path, paragraph_index, run_index, bold, italic, underline, font_size, font_name)
...
async def add_table(
    ...
    data: Optional[List[List[str]]] = Field(None, description="Table data (optional)"),
...
async def analyze_document(
    ...
    return doc_ops.analyze_document(file_path, include_structure, include_formatting, include_statistics)
