...
For MCP-EVAL planning, including scenario requirements, execution boundaries,
security considerations, and impact on the gateway, see
[MCP Evaluation Requirements and Architecture Analysis](mcp-eval-architecture.md).
