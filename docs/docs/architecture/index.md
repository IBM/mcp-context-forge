...
- Plugin configuration via YAML with hot-reload support. This doesn't apply to Praxis generations; No hot reload is
  supported for that immutable delivery path.
