...
- **Python echo agent**: Serves v1 agent cards natively without translation layers
- **Rust echo agent**: Serves v1 agent cards natively without SDK dependencies or translation layers
- **Simplified routing**: The A2A runtime routes both v1 and legacy method names identically
