...
pub(crate) fn generator_fields_suite() -> Vec<GeneratorField> {
    vec![
        text_field("File Stem", "file_stem", "new-scenario", "Output file name under crates/contextforge_benchmark_runner/assets/scenarios/."),
        ...
        text_field("Container File", "container_file", "crates/contextforge_benchmark_runner/assets/Containerfile", "defaults.build.container_file"),
