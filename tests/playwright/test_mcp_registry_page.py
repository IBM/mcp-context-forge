...
class TestMCPRegistryPage:
    ...
    def test_category_filter_functionality(self, mcp_registry_page: MCPRegistryPage):
        ...
        assert filtered_count <= initial_count, \
            "Filtered results should not exceed initial count"
    ...
    def test_search_functionality(self, mcp_registry_page: MCPRegistryPage):
        ...
        assert search_count <= initial_count, \
            "Search results should not exceed initial count"
    ...
    def test_clear_filters_functionality(self, mcp_registry_page: MCPRegistryPage):
        ...
        # Count after clearing should be greater than or equal to filtered count
        assert cleared_count >= filtered_count, \
            "Clearing filters should show more or equal servers"
...
class TestMCPRegistryPageIntegration:
    ...
    def test_combined_filters(self, mcp_registry_page: MCPRegistryPage):
        ...
        assert combined_count <= category_count, \
            "Combined filters should not show more results than single filter"
        assert combined_count <= initial_count, \
            "Combined filters should not show more results than no filters"
    ...
    def test_search_with_filters(self, mcp_registry_page: MCPRegistryPage):
        ...
        assert search_count <= filtered_count, \
            "Search with filter should not show more results than filter alone"
    ...
    def test_server_count_consistency(self, mcp_registry_page: MCPRegistryPage):
        ...
        assert after_filters_total == initial_total, \
            "Total server count should remain consistent"
