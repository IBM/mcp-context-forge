        ...
        return_value=FakeForm(
            {
                ...
                "associatedTools": ["550e8400e29b41d4a716446655440001", "550e8400e29b41d4a716446655440002"],
                "associatedResources": ["550e8400e29b41d4a716446655440003"],
                "associatedPrompts": ["550e8400e29b41d4a716446655440004"],
            ...
            return_value=FakeForm(
                {
                    ...
                    "icon": "http://example.com/icon.png",
                    "associatedTools": ["550e8400e29b41d4a716446655440001"],
                    "associatedResources": [],
                    "associatedPrompts": [],
                    "is_inactive_checked": "false",
                    "visibility": "private",
