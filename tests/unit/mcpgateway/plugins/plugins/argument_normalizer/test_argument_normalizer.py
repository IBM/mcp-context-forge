...
async def test_casing_and_numbers():
    ...
    payload = PromptPrehookPayload(prompt_id="case", args={"v": "  JOHN DOE owes 1.234,56 EUR  "})
...
async def test_dates_day_first_and_mdy():
    ...
    payload = PromptPrehookPayload(prompt_id="dates", args={"a": "Due 31/12/2023", "b": "Start 12/31/2023"})
