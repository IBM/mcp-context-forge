...
async def test_manager_initializes_packaged_plugins_from_shipped_configs(tmp_path: Path, source_config: str, expected_names: set[str]):
    """Shipped packaged-plugin entries should import through the real PluginManager."""
    PluginManager.reset()
    ...
    smoke_config = {
        ...
        "plugin_settings": {**config.get("plugin_settings", {}), "fail_on_plugin_error": True},
        "plugins": selected_plugins,
    }
    config_path = tmp_path / f"{source_path.stem}-packaged-smoke.yaml"
