...
async def test_hook_methods_empty_content():
    ...
    with pytest.raises(PluginError):
        await plugin.invoke_hook(HookType.PROMPT_PRE_FETCH, payload, context)
    ...
    with pytest.raises(PluginError):
        await plugin.invoke_hook(HookType.RESOURCE_POST_FETCH, payload, context)
