# -*- coding: utf-8 -*-
"""Module Description.
Location: ./tests/unit/mcpgateway/services/test_reverse_proxy_live_harness.py
...
RUNNER: Final = Path(__file__).parents[3] / "live_gateway" / "reverse_proxy" / "run.sh"
NAMESPACE_KEYS: Final = (
    ...
    "RP_FAST_CLIENT_CONTAINER",
    "RP_COMPLIANCE_CLIENT_CONTAINER",
    "RP_AUTH_CLIENT_CONTAINER",
)
PORT_KEYS: Final = (
    "FAST_TEST_PORT",
    "POSTGRES_HOST_PORT",
