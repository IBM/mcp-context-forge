...
This test file specifically targets exception handling paths in:
- prompt_service.py line 1705-1706
- resource_service.py line 2410-2411
- resource_service.py line 3587 (server_id filter)
- tool_service.py line 4121-4122
"""
...
class TestPromptServiceMetricsException:
    ...
    async def test_get_prompt_server_metric_recording_failure(self, prompt_service):
        ...
        with patch("mcpgateway.services.prompt_service.metrics_buffer", mock_metrics_buffer), \
...
class TestResourceServiceMetricsException:
    ...
    async def test_read_resource_server_metric_recording_failure(self, resource_service):
        ...
        with patch("mcpgateway.services.resource_service.metrics_buffer", mock_metrics_buffer), \
