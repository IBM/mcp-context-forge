...
# First-Party
from mcpgateway.services.performance_tracker import PerformanceTracker, get_performance_tracker
...
class TestPerformanceTrackerInit:
    ...
    def test_init_uses_default_max_samples(self):
        ...
        with patch("mcpgateway.services.performance_tracker.settings") as mock_settings:
            ...
            type(mock_settings).perf_max_samples_per_operation = property(
                lambda self: getattr(self, "_perf_max_samples_per_operation", None)
            )
