...
async def test_go_and_rust_fast_servers_match_time_conversion_through_contextforge(client: Client) -> None:
    ...
    rust_convert = _find_tool(tools, "fast-time-convert-time", ("fast-time", "fast-time-server", "rust"), "convert-time")
...
async def test_rust_fast_server_latency_tracks_go_through_contextforge(client: Client) -> None:
    ...
    rust_time = _find_tool(tools, "fast-time-get-system-time", ("fast-time", "fast-time-server", "rust"), "get-system-time")
