...
Note that if the pre-commit check fails on secret scanning you need to identify whether anything sensitive was introduced and remove it or replace it with safe test fixtures.
